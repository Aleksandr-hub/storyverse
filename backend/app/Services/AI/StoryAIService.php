...
class StoryAIService
{
    ...
    private function buildIntroSection(bool $isAdult): string
    {
        ...
        $prompt .= "=== ФОРМАТ ТЕКСТУ ===\n";
        $prompt .= "Генеруй текст у HTML форматі для редактора:\n";
        $prompt .= "- Кожен абзац огортай в <p>...</p>\n";
        $prompt .= "- Для заголовків використовуй <h2>...</h2> або <h3>...</h3>\n";
        $prompt .= "- Для виділення: <strong>жирний</strong>, <em>курсив</em>\n";
        $prompt .= "- НЕ використовуй markdown синтаксис (**, ##, - тощо)\n";
        $prompt .= "- НЕ використовуй <h1> (це для назви історії)\n\n";
